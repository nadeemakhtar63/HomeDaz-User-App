...
class BookingInfo{
  ...
  BookingInfo({ required this.DocumentId,required this.Address,required this.Datepic,required
  ...
  BookingInfo.fromDocumentSnapshot({required DocumentSnapshot documentSnapshot})
  {
