                  ...
                  suffixIcon: Padding(
                    ...
                    child: IconButton(
                        onPressed: ()async{
                          ...
                          // FirebaseDB.updatelasttextmesage("Image Share", widget.uid, "img");
                          await widget.idkey=="msg"? FirebaseDB.addImageData(todoModel,widget.imageFile!,widget.uid):
                          // FirebaseDB.addStatuesImageData(todoModel,widget.imageFile!,widget.uid);

                          await FirebaseDB.updatelasttextmesage(contentTextEditorController.text.trim(),widget.uid,"img");
